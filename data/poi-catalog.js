export const poiCategories = [
  { id: 'water', label: 'Wasser', icon: '💧', color: '#45d6ff', tags: ['amenity=drinking_water'] },
  { id: 'toilet', label: 'WC', icon: 'WC', color: '#9caab7', tags: ['amenity=toilets'] },
  { id: 'supplies', label: 'Versorgung', icon: '🛒', color: '#ffd166', tags: ['shop=supermarket', 'shop=convenience'] },
  ...
  { id: 'viewpoint', label: 'Aussicht', icon: '⌖', color: '#35d49f', tags: ['tourism=viewpoint'] },
  { id: 'shelter', label: 'Schutz', icon: '⌂', color: '#c7b7ff', tags: ['amenity=shelter', 'emergency=*'] },
...
export const categoryAliases = [
  ...
  { match: ['kueste', 'küste', 'strand'], category: 'landscape' },
